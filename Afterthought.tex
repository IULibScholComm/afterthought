...
\href{https://iulibrariespublishing.iu.edu/afterthought/}{HTML version};
...
{\centering \includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={Lila with her younger brothers, Earl and Looy, c.~1931}]{images/Akou02.JPG}
...
{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={I developed this chart using Ancestry.com and census records. Only people who were alive during Lila's lifetime are listed; younger children and later generations are not. The fathers of Lila's last four children are speculative but are included as a reference for readers.}]{images/Akou03.jpg}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio,alt={Houseboats along the river in La Crosse. Library of Congress Prints and Photographs Division, \#LC-USF33-003063-M4. Photograph by Arthur Rothstein (1915--1985) in 1939.}]{images/Akou04-enlarged.jpg}}
...
{\centering \includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={Article on the front page of the La Crosse Tribune, November 5, 1929}]{images/Akou05.jpg}
...
{\centering \includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={Page six of the La Crosse Tribune, August 15, 1930}]{images/Akou06.jpg}
...
{\centering \includegraphics[width=0.6\linewidth,height=\textheight,keepaspectratio,alt={Front page of the La Crosse Tribune, November 4, 1933}]{images/Akou07cropped.jpg}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio,alt={Page eight of the La Crosse Tribune, October 4, 1935}]{images/Akou08.jpg}}
...
For more information, see Mary Bosworth, ed.\footnote{\citeproc{ref-bosworth2005a}{\emph{Encyclopedia
  ...
  SAGE Publications, 2005)}.} Lawrence J. Friedman and Mark D. McGarvie,
eds.\footnote{\citeproc{ref-friedman2003a}{\emph{Charity, Philanthropy,
  and Civility in American History} (Cambridge University Press, 2003)}.}
and Ted Gup.\footnote{\citeproc{ref-gup2010a}{\emph{A Secret Gift: How
  One Man's Kindness---and a Trove of Letters---Revealed the Hidden
  History of the Great Depression} (New York: Penguin Publishing,
  2010)}.}
...
{\centering \includegraphics[width=0.8\linewidth,height=\textheight,keepaspectratio,alt={Front page of the La Crosse Tribune, November 13, 1938}]{images/Akou09.jpg}
...
{\centering \includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio,alt={Poster advertising the YWCA and Girl Reserves; Library of Congress Prints and Photographs Division, \# LC-USZC4-5551}]{images/Akou10recropped.jpg}
...
{\centering \includegraphics[width=1\linewidth,height=\textheight,keepaspectratio,alt={A busy street in downtown La Crosse, 1939; Library of Congress Prints and Photographs Division, \#LC-USF33-003068-M2}]{images/Akou11.jpeg}
...
For more information, see Jay P. Dolan,\footnote{\citeproc{ref-dolan2010a}{\emph{The
  Irish Americans: A History} (New York: Bloomsbury USA, 2010)}.} Thomas
D. Snyder,\footnote{\citeproc{ref-snyder1993a}{\emph{120 Years of
...
{\centering \includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio,alt={Lila (middle of the back row) as a sophomore in 1939 with some of her classmates at Logan High School}]{images/Akou12.jpg}
...
Schaefer Riley.\footnote{\citeproc{ref-riley2013a}{\emph{'Til Faith Do
...
For more information, see Vicki Howard,\footnote{\citeproc{ref-howard2008a}{\emph{Brides,
  ...
  University of Pennsylvania Press, 2008)}.} Samanta Leonard,\footnote{\citeproc{ref-leonard2019a}{\emph{Groomed:
...
{\centering \includegraphics[width=0.55\linewidth,height=\textheight,keepaspectratio,alt={Page 4 of the La Crosse Tribune, December 30, 1941}]{images/Akou13.jpg}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio,alt={Postcard of Wisconsin State Prison in Waupun, where Lloyd was sent in the 1940s}]{images/Akou14rt.jpg}}
...
{\centering \includegraphics[width=0.65\linewidth,height=\textheight,keepaspectratio,alt={Lila as a young working woman, circa 1943}]{images/Akou15.jpg}
...
{\centering \includegraphics[width=0.75\linewidth,height=\textheight,keepaspectratio,alt={Lila, circa 1948. In the center is her oldest daughter, Myrtle Joyce. Her son, John, is sitting in her lap. Standing on her left are Veda's children, Patty and David.}]{images/Akou16.JPG}
...
{\centering \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={I developed this genealogical chart using data from ancestry.com. It does not include most of Lila's children, because Herman only fathered her second and third children (John and Alice). Alice was my mother.}]{images/Akou17.jpeg}
...
{\centering \pandocbounded{\includegraphics[keepaspectratio,alt={A postcard of St.~Francis Hospital from the 1920s; it was the first major hospital in La Crosse, established by the Catholic Church in 1883.}]{images/Akou18.jpg}}
...
Pamela Riney-Kehrberg, ed.\footnote{\citeproc{ref-riney-kehrberg2016a}{\emph{The
  Routledge History of Rural America} (New York: Routledge, 2016)}.} and
Lydia Semler, Jana Hill, and Ilea Magdelina Bonner.\footnote{\citeproc{ref-semler2024a}{\emph{A
...
{\centering \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Advertisement for Fields on Page Three of the La Crosse Tribune, September 10th, 1944}]{images/Akou19.jpg}
...
{\centering \includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio,alt={Self-portrait that Myrtle gave to Lila around the time of her marriage in 1944; the handwritten inscription says, ``Love to Lila, From Myrtle''}]{images/Akou20.jpeg}
...
{\centering \includegraphics[width=0.5\linewidth,height=\textheight,keepaspectratio,alt={Herman and Lila Schneider on their wedding day, October 14, 1944}]{images/Akou21edit.jpg}
...
Mullen,\footnote{\citeproc{ref-mullen2017a}{\emph{The Chance of
  ...
  University Press, 2017)}.} and Raymond DeVries et al., eds.\footnote{\citeproc{ref-devries2001a}{\emph{Birth
  by Design: Pregnancy, Maternity Care, and Midwifery in North America
...
{\centering \includegraphics[width=0.55\linewidth,height=\textheight,keepaspectratio,alt={Lila (back) and Myrtle Schneider (front) circa 1946; used by permission of June Lewis}]{images/Akou22.JPG}
...
{\centering \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Farmland and bluffs in La Crosse County, Wisconsin; Library of Congress Prints and Photographs Division, \# LC-DIG-highsm-40479}]{images/Akou23.jpg}
...
For more information, see Jerry Apps,\footnote{\citeproc{ref-apps2006a}{\emph{When
  ...
  of Britain and Ireland} (San Francisco: Oak Publications, 1984)}.} and
Alvin Martin Peterson.\footnote{\citeproc{ref-peterson1948a}{\emph{Palisades
...
{\centering \includegraphics[width=0.85\linewidth,height=\textheight,keepaspectratio,alt={Lila with members of the Schneider family, circa 1952. Top row from the left: Helen, Minnie (Herman's aunt), Lila, Elvera (wife of Herman's brother, Raymond); Bottom row: Charlotte (wife of Herman's brother, John), Myrtle, Nora, and Grace}]{images/Akou24.jpeg}
...
Leslie J. Reagan.\footnote{\citeproc{ref-reagan2022a}{\emph{When
...
Speltz,\footnote{\citeproc{ref-draeger2012a}{\emph{Bottoms up: A Toast
  to Wisconsin's Historic Bars and Breweries} (Madison: Wisconsin
...
{\centering \includegraphics[width=0.55\linewidth,height=\textheight,keepaspectratio,alt={Lila and her niece, Patty Metcalf, circa 1953}]{images/Akou25rt.jpg}
...
Adler Falk,\footnote{\citeproc{ref-weinberg2017a}{\emph{The American
  Drug Culture} (Thousand Oaks, California: SAGE Publications, 2017)}.}
and Toni Weschler.\footnote{\citeproc{ref-weschler1995a}{\emph{Taking
...
{\centering \includegraphics[width=0.55\linewidth,height=\textheight,keepaspectratio,alt={Myrtle Joyce, Alice, Hazel, and Bonnie; Christmas 1956}]{images/Akou26rt.jpg}
...
{\centering \includegraphics[width=0.55\linewidth,height=\textheight,keepaspectratio,alt={Herman and Emma, circa 1970}]{images/Akou27rt.jpg}
...
Wright,\footnote{\citeproc{ref-chan2020a}{{``Effect of Amphetamines on
  ...
  12 (2020), \url{https://doi.org/10.1002/14651858.CD007896.pub3}}.} Ray
J. Defalque and Amos J. Wright,\footnote{\citeproc{ref-defalque2011a}{{``Methamphetamine
